...
function FooterPage() {
    ...
    return (
        <>
            <div id="contact" className="flex flex-col items-center justify-end w-full h-screen bg-zinc-800 px-20 py-10">
                <div className="grid grid-rows-1 grid-cols-2 w-full h-1/2">
                    ...
                    <div className="grid grid-cols-2 grid-rows-1 w-full h-full">
                        <div></div>
                        <div className="flex flex-row w-full h-full items-end justify-start gap-2">
                            <p>Copyright © { year };</p>
                            <p>Designed by</p>
